...
class MunicipalityRepositoryImpl(
    ...
    override fun findByTypeAndDistrict(
        type: np.gov.likhupikemun.dpms.location.domain.MunicipalityType,
        districtCode: String,
    ...
    override fun findByType(type: np.gov.likhupikemun.dpms.location.domain.MunicipalityType): List<Municipality> =
